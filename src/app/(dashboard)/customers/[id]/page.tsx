                ...
                <TabsContent value="details" className="space-y-4">
                  ...
                  {customer.notes && (
                    <div>
                      ...
                      <p className="whitespace-pre-line mt-1">{customer.notes}</p>
                    </div>
                  )}
                </TabsContent>
                <TabsContent value="deals">
                  <div className="p-4 text-center">
                    ...
                    <p className="text-sm text-gray-500">
                      Create a new deal for this customer to track opportunities.
                    </p>
                    <Button className="mt-4" onClick={() => router.push('/deals/new')}>
                      Create Deal
                    </Button>
                  </div>
                </TabsContent>
        ...
        <div>
          <Card>
            ...
            <CardContent>
              {customer.assignedTo ? (
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{customer.assignedTo.email}</p>
                  </div>
                </div>
              ) : (
              ...
              {checkPermission('customers', 'update') && (
                <Button variant="outline" className="w-full mt-4" onClick={() => router.push(`/customers/${id}/edit`)}>
                  Change Assignment
                </Button>
              )}
            </CardContent>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the customer {customer.name}. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
